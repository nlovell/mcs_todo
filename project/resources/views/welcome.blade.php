            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex align-items-center" v-for="(task, tast_index) in tasks" :key="task.id">
                            <div class="task_checkbox d-inline-flex justify-center">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" :checked="task.done==1"   @click="task_done_toggle(tast_index)">
                                </div>
                            </div>
                        ...
                        <div class="list-group-item d-flex align-items-center">
                            <div class="task_checkbox d-inline-flex justify-center"></div>
                            <input v-model="new_task_text" class="task_text" @blur="addTask()" placeholder="New task">
                        </div>
                    </div>
                </div>
            </div>
